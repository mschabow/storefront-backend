...
- .env file
This would not normally be included and excluded from , and I have created a .env.template to show the values. However for ease of instructor testing, I have included the .env file.
